...
class LoginTest(unittest.TestCase):
    ...
    def test_login01(self):
        """orc admin正常登录"""
        self.log.info("=================test_login01开始测试========================")
        # 获取测试数据
        ...
        # 发送请求
        self.log.info(message="发送请求", name="orc admin正常登录", line=37)
        ...
        self.log.info(message="返回数据%s" % dict_json, name="orc admin正常登录", line=38)
        ...
        self.log.info("=================test_login01测试结束========================")
