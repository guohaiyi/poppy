...
class CreateTenantDbTest(unittest.TestCase):
    ...
    def test01_block_account(self):
        """阻塞Tenant admin账户"""
        self.log.info(message="test01_block_account", name="test07_BlockUnblockAdmin.py", line=32)
        # 设置请求数据
    ...
    def test02_block_account(self):
        """禁用TenantDB失败：不存在"""
        self.log.info(message="test02_block_account", name="test07_BlockUnblockAdmin.py", line=64)
        # 设置请求数据
        ...
        self.assertEqual(dict_json["err"]["message"], "Tenant Admin account doesn't exist",
                         msg='>>>断言失败，实际返回结果：%s' % dict_json["err"]["message"])

    def test03_unblock_account(self):
        """疏通Tenant admin账户"""
        self.log.info(message="test03_unblock_account", name="test07_BlockUnblockAdmin.py", line=90)
        # 设置请求数据
    ...
    def test04_unblock_account(self):
        ...
        self.log.info(message="test04_unblock_account", name="test07_BlockUnblockAdmin.py", line=118)
        # 设置请求数据
