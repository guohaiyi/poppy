...
class CreateTenantDbTest(unittest.TestCase):
    ...
    def test01_get_db_data(self):
        """通过name获取Tenant DB信息"""
        self.log.info(message="test01_get_db_data", name="test04_GetTenantDbData.py", line=32)
        # 设置请求数据
    ...
    def test02_get_db_data(self):
        ...
        self.log.info(message="test02_get_db_data", name="test04_GetTenantDbData.py", line=32)
        # 设置请求数据
    ...
    def test03_get_db_data(self):
        """通过db获取Tenant DB信息"""
        self.log.info(message="test03_get_db_data", name="test04_GetTenantDbData.py", line=32)
        # 设置请求数据
    ...
    def test05_delete_db(self):
        """删除Tenant DB成功"""
        self.log.info(message="test05_delete_db", name="test04_GetTenantDbData.py", line=32)
        # 设置请求数据
